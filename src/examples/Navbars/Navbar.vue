<template>
  ...
  >
    <div class="px-3 py-1 container-fluid">
      ...
      <div
        class="mt-2 collapse navbar-collapse justify-content-end mt-sm-0 me-md-0 me-sm-4"
      ...
      >
        <ul class="navbar-nav justify-content-end">
          <li class="nav-item d-flex align-items-center">
            ...
            >
              <i
                class="fa fa-user text-dark"
                :class="this.$store.state.isRTL ? 'ms-sm-2' : 'me-sm-2'"
              ></i>
              <span v-if="this.$store.state.isRTL" class="d-sm-inline d-none"
                >يسجل دخول</span
              >
              <span v-else class="d-sm-inline d-none text-dark">Sign In</span>
            </router-link>
          </li>
